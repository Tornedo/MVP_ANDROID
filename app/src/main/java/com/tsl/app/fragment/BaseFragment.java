...
public abstract class BaseFragment extends Fragment implements Processing {
    ...
    public void showAlert(String title, String message, final AlertCallback callback, Context context) {
        AlertDialog.Builder alert = new AlertDialog.Builder(context);
        alert.setTitle(title);
        alert.setMessage(message);
        alert.setPositiveButton(getString(android.R.string.ok),
    ...
    protected void keypadOffonStart(Context context) {
